...
- `Patch 33 — Contextual Cold-Start Dictionary Quality` هي Final Base الحالية والوحيدة بعد تأكيد المستخدم: `تم التطبيق بنجاح` بتاريخ 2026-08-03.
...
- اعتُمدت Patch 33 كقاعدة البناء الحالية بعد نجاح الاقتراحات السياقية واتجاه بطاقات الذاكرة.
...
- أزيل الرجوع التلقائي إلى كلمات التحية الثابتة بعد كل مسافة عند عدم وجود ذاكرة تعلم.
...
## Patch 34 — Keyboard Personalization & Compose Viewport (Candidate)
